...
SSID = 'ANTONIOBM'  # Nombre de la red Wi-Fi
PASSWORD = '12345678'  # Contraseña de la red Wi-Fi

# 🌐 Configuración de MQTT
MQTT_SERVER = '192.168.137.167'  # Dirección del broker Mosquitto
MQTT_PORT = 1883  # Puerto del broker Mosquitto
MQTT_TOPIC = "utng/mq7"  # Tema MQTT para el sensor MQ-7
...
mq7_analog = ADC(Pin(32))  # Salida AO del MQ-7 a GPIO34
